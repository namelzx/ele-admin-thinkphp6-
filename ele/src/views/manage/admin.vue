    ...
    <div  class="filter-container">
      <div class="filter-container-warp">
        <el-form :inline="true" :model="listQuery" class="form-inline">
          ...
          <div>
            <el-form-item label="">
              <el-select size="mini" v-model="listQuery.groupId" class="filter-item" placeholder="请选择岗位">
          ...
          <div>
            <el-form-item label="">
              <el-input placeholder="请输入姓名" v-model="listQuery.realName" clearable>
                <template slot="prepend">姓名</template>
              </el-input>
            </el-form-item>
            <el-form-item label="">
              <el-input placeholder="请输入电话" v-model="listQuery.phone" clearable>
      ...
      <el-table-column label="操作" align="center" min-width="180px" class-name="small-padding fixed-width" fixed="right">
        <template slot-scope="scope">
          <el-tooltip content="编辑" placement="top">
            <el-button  size="mini" type="text"  @click="handleUpdate(scope.$index,scope.row.id)">编辑</el-button>
          </el-tooltip>
          <el-tooltip content="删除" placement="top">

            <el-button size="mini" :loading="scope.row.delete" @click="handleDelete(scope.$index,scope.row.id)" type="text">删除</el-button>
...
<script>
  import { GetDataByList, del, change, delAll, changeAll } from '@/api/admin'
  import waves from '@/directive/waves'
  import { parseTime, pickerOptions, getArrByKey } from '@/utils'
  import adminForm from './admin/form'
  import openWindow from '@/utils/openWindow'
  import {  GetRoleBylist } from '@/api/roles'
